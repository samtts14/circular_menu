...
void main() {
  runApp(ApagarEncender());
}

class ApagarEncender extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ApagarEncenderScreen(),
    );
  }
}

class ApagarEncenderScreen extends StatefulWidget {
  @override
  _ApagarEncenderScreenState createState() => _ApagarEncenderScreenState();
}

class _ApagarEncenderScreenState extends State<ApagarEncenderScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Apagar/Encender Vehículos'),
      ),
      body: Column(
        children: [
          Expanded(
    ...
    Column(
      children: [
        ElevatedButton(
          ...
          onPressed: selectedVehicleIndex != -1 ? _encenderVehiculo : null,
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
        ...
        ElevatedButton(
          ...
          onPressed: selectedVehicleIndex != -1 ? _apagarVehiculo : null,
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            mainAxisSize: MainAxisSize.min,
            children: [
